...
> The normalized schema is **LLD §21**. Where this document's field set
> differs, the LLD wins; extras belong in the `ext.<vendor>.` namespace
> described in `edge-collector/04-normalization-engine.md` §5.
