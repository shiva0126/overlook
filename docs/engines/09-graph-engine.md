...
> The graph is **SaaS-side** (LLD §76). The collector emits Entities and
> Relationships (LLD §24, §25) and holds no graph. See `../edge-
> collector/12-saas-side.md` §4 for the engine recommendation.
